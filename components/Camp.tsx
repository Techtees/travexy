...
const CampSite = ({backGroundImage, title,subTitle, peopleJoined}: CampProps) => {
    return(
        <div className={`h-full w-full min-w-[1100px] ${backGroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
            <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg-10">
                ...
                <div className="flexCenter gap-6">
                    ...
                    <p className="bold-16 mdLbold-20 text-white">
                        {peopleJoined}
                    </p>
                </div>
            </div>
...
const Camp = () => {
    return(
        <section className="2xl:max-container relative flex flex-col py-10 lg:py-20 xl:mb-20">
            <div className="hide-scrollbar flex h-[340px] w-fill items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
                <CampSite
